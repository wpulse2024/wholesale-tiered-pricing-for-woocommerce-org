<div class="wholesale-tiered-pricing-for-woocommerce-premium">
    <?php 
    wp_enqueue_style('wholesale-tiered-pricing-for-woocommerce-premium', WC_ROLE_PRICING_PLUGIN_URL . 'assets/minimal-template.css', array(), WC_ROLE_PRICING_VERSION);
        ...
        <div class="premium-pricing-wrapper">
            <div class="premium-header">
                <h4 class="premium-title">
                    ...
                    <?php esc_html__('Volume Savings', 'wholesale-tiered-pricing-for-woocommerce'); ?>
                </h4>
            </div>
            ...
            <div class="premium-tiers">
                ...
                foreach ($rule['tiered_pricing'] as $index => $tier):
                    if (!empty($tier['min_qty']) && !empty($tier['price'])):
                        ...
                        $is_featured = ($index === $tier_count - 1);
                ?>
                <div class="premium-tier <?php echo $is_featured ? 'featured-tier' : ''; ?>">
                    <?php if ($is_featured): ?>
                        <span class="featured-badge"><?php esc_html__('Best', 'wholesale-tiered-pricing-for-woocommerce'); ?></span>
                    <?php endif; ?>
                    ...
                    <div class="tier-content">
                        ...
                        <div class="tier-center">
                            <?php if ($savings > 0 && $regular_price != $tier['price']): ?>
                                <span class="regular-price"><?php echo esc_html(wc_price($regular_price)); ?></span>
                            <?php endif; ?>
                            <span class="sale-price"><?php echo esc_html(wc_price($tier['price'])); ?></span>
                        </div>
            ...
            <div class="premium-footer">
                ...
                <span><?php esc_html__('Applied at checkout', 'wholesale-tiered-pricing-for-woocommerce'); ?></span>
            </div>
        </div>
    <?php 
        endif;
