Perfect 👍 thanks for sharing your **exact plugin name and description**.
I’ll now rewrite the **README.txt** optimized for **WordPress.org SEO** so it aligns with your plugin header:
...
* Supports custom roles created by membership/role management plugins.
